...
function statusClass(item: ImageProviderCardItem) {
...
<template>
  <div class="provider-board">
    <!-- 可点击统计条 -->
    <div class="stats-strip" role="group" aria-label="按状态过滤图片来源">
      <button
        type="button"
        class="stat-chip"
    ...
    <el-empty
      ...
      :description="
        statusFilter === 'all' ? '暂无图片来源数据' : '当前过滤条件下无图片来源'
      "
    >
      <el-button
